+++
title = "Popup Success Page Settings"
...
The settings for the popup success page http://www.ksmadhavan.in/popup_success/ are contained in the `popup_success.md` file which is in the `content` folder. You can view the sample page [in the demo site](https://template.thinkingtree.me/popup_success/)
