...
If you went through the documentation, [Understanding Static Sites](/docs/understand_static_sites/introduction/), then great we have covered most of this. These sub-sections are even more relevant: [how information is stored](/docs/understand_static_sites/static_website_generators/#how-is-information-stored) and [where information is stored](/docs/understand_static_sites/static_website_generators/#where-is-information-stored)

### How information is stored

The tldr on how information is stored is that configurations are stored in [toml format](https://github.com/toml-lang/toml) and html content is stored in [markdown format](https://github.com/adam-p/markdown-here/wiki/Markdown-Cheatsheet)

### Where information is stored

The tldr on where information is stored is that
...
3. Then if you press Ctrl+Shift+F you can choose the word you want replaced. For example, lets say you choose 'ksmadhavan.in'. Add the word you want to replace with but don't press 'Replace All' yet.
4. Choose the Find All option and a window will open up with the options
5. In this window, clicking each result will show you the context of the word in a separate window and you can replace it with anything you want. In this case, you would want to replace ksmadhavan.in with yourrealdomainname.com.
...
3. Then if you press Ctrl+Shift+F a frame opens up on the left. Type the word you want replaced. For example, lets say you choose 'ksmadhavan.in' and press Enter
